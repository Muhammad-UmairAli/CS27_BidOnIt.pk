          ...
          <div key={product._id} className="col-lg-3 col-md-4 col-sm-6">
            ...
            <div className="card card-style my-2">
              ...
              <Link to={`../single-product/${product._id}`}>
                ...
                <p className="text-center">{product.bidBy !== undefined && product.bidBy !== null ? 'Bid' : 'Bid Starts From'} : Rs.{ product.bidAmount }/- { product.bidByName !== undefined && product.bidByName !== null ? ' by : '+product.bidByName : ''}</p>
