...
export default class SellerProductsTable extends Component {
  dltcolumn = {
    key: 'delete',
    content: product => (
  ...
  columns = [
    ...
    content: product => ( 
    product.imageUrl ? <img alt="..." src={`./products/${product._id}`}></img> : <img alt="..." src={product.imageUrl}/>,
    <img
  ...
  render() {
    ...
    return (
      <div className="container">
        <table  className="table display responsive nowrap" id="sprodtable">
